...
impl ATECC608A_EXECUTION_TIME {
    ...
    pub fn get_t_exec(self) -> usize {
        match self {
            ATECC608A_EXECUTION_TIME::ATCA_AES(ATCA_AES) => 27,
            ATECC608A_EXECUTION_TIME::ATCA_CHECKMAC(ATCA_CHECKMAC) => 40,
            ATECC608A_EXECUTION_TIME::ATCA_COUNTER(ATCA_COUNTER) => 25,
            ATECC608A_EXECUTION_TIME::ATCA_DERIVE_KEY(ATCA_DERIVE_KEY) => 50,
            ATECC608A_EXECUTION_TIME::ATCA_ECDH(ATCA_ECDH) => 60,
            ATECC608A_EXECUTION_TIME::ATCA_GENDIG(ATCA_GENDIG) => 25,
            ATECC608A_EXECUTION_TIME::ATCA_GENKEY(ATCA_GENKEY) => 115,
            ATECC608A_EXECUTION_TIME::ATCA_INFO(ATCA_INFO) => 5,
            ATECC608A_EXECUTION_TIME::ATCA_KDF(ATCA_KDF) => 165,
            ATECC608A_EXECUTION_TIME::ATCA_LOCK(ATCA_LOCK) => 35,
            ATECC608A_EXECUTION_TIME::ATCA_MAC(ATCA_MAC) => 55,
            ATECC608A_EXECUTION_TIME::ATCA_NONCE(ATCA_NONCE) => 20,
            ATECC608A_EXECUTION_TIME::ATCA_PRIVWRITE(ATCA_PRIVWRITE) => 50,
            ATECC608A_EXECUTION_TIME::ATCA_RANDOM(ATCA_RANDOM) => 23,
            ATECC608A_EXECUTION_TIME::ATCA_READ(ATCA_READ) => 5,
            ATECC608A_EXECUTION_TIME::ATCA_SECUREBOOT(ATCA_SECUREBOOT) => 80,
            ATECC608A_EXECUTION_TIME::ATCA_SELFTEST(ATCA_SELFTEST) => 250,
            ATECC608A_EXECUTION_TIME::ATCA_SHA(ATCA_SHA) => 36,
            ATECC608A_EXECUTION_TIME::ATCA_SIGN(ATCA_SIGN) => 115,
            ATECC608A_EXECUTION_TIME::ATCA_UPDATE_EXTRA(ATCA_UPDATE_EXTRA) => 10,
            ATECC608A_EXECUTION_TIME::ATCA_VERIFY(ATCA_VERIFY) => 105,
            ATECC608A_EXECUTION_TIME::ATCA_WRITE(ATCA_WRITE) => 45,
            _ => 0,
        }
    }
}
